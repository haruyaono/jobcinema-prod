...
$factory->define(JobItem::class, function (Faker\Generator $faker) {
    ...
    return [
        ...
        'status' => 2,
        'job_img' => $file->store('jobitems', ['disk' => 'public']),
        'job_img2' =>  $file->store('jobitems', ['disk' => 'public']),
        'job_img3' => '',
        'job_mov' =>  $file->store('jobitems', ['disk' => 'public']),
        'job_mov2' =>  $file->store('jobitems', ['disk' => 'public']),
        'job_mov3' => '',
