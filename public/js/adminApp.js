...
var Notifier = /*#__PURE__*/function () {
  ...
  _createClass(Notifier, [{
    key: "info",
    value: function info(msg, tl, cfgOvr) {
      this.notify('info', msg, tl, cfgOvr);
    }
  }, {
    key: "success",
    value: function success(msg, tl, cfgOvr) {
      this.notify('success', msg, tl, cfgOvr);
    }
  }, {
    key: "warning",
    value: function warning(msg, tl, cfgOvr) {
      this.notify('warning', msg, tl, cfgOvr);
    }
  }, {
    key: "error",
    value: function error(msg, tl, cfgOvr) {
      this.notify('error', msg, tl, cfgOvr);
    }
  }, {
    key: "notify",
    value: function notify(lvl, msg, tl, cfgOvr) {
      var cfg = this.cfg[lvl];
...
__webpack_require__(/*! ./admin/toatsr.js */ "./resources/js/admin/toatsr.js");
...
module.exports = __webpack_require__(/*! /var/www/html/src/resources/js/adminApp.js */"./resources/js/adminApp.js");
