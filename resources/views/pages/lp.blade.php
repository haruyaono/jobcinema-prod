...
<header class="header">
		<div class="inner">
          <div class="logo"><a href="/"><img src="{{ asset('/uploads/images/jobcinema_rogo_re.png') }}" alt="JOBCiNEMA"></a></div>
        <div class="header-right">
          <div class="contact">
            <p>まずは相談</p>
            <p class="number">080-8297-8600</p>
          </div>
...
<main class="main-lp">
    <div class="inner">
      ...
      <img class="lp-main-image" src="{{ asset('/uploads/images/job-cinema_lp.png') }}" alt="JOB CiNEMA">
    ...
    <section class="section2">
      <h2><i class="fas fa-video faa-spin animated"></i>「ユーザーファーストなシステムを目指しております」</h2>
