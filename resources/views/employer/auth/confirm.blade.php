            ...
            <table class="table table-bordered">
              <tbody>
                <tr>
                  ...
                  <td>{{ Session::get('company_form.email') }}</td>
                </tr>
                <tr>
                  <th scope="row">パスワード</th>
                  <td>
                    {{ Session::get('company_form.password_mask') }}
                  </td>
                </tr>
                <tr>
                  <th scope="row">会社名（店舗名）</th>
                  <td colspan="2">{{ Session::get('company_form.cname') }}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2">{{Session::get('company_form.phone1') }}-{{Session::get('company_form.phone2') }}-{{Session::get('company_form.phone3') }}</td>
                </tr>
              </tbody>
            </table>
