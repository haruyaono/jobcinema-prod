  ...
  <section class="main-section emp-register-section">
    <div class="inner">
      <div class="pad">
        ...
        <div class="text-center my-5 only-pc"><a class="txt-blue-link" href="{{route('employer.login')}}">ログインページ</a></div>
        <div class="text-center my-4 only-sp"><a class="txt-blue-link" href="{{route('employer.login')}}">ログインページ</a></div>
      </div>
