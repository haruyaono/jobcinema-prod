...
<section class="main-section s-mypage-section">
    <div class="inner">
        <div class="pad">
            ...
            <p class="mypage-hello-text">ようこそ<i class="fas fa-user mx-1"></i>{{$user->last_name}} {{$user->first_name}}さん <span class="caret"></span></p>
            @else
            ...
            <div class="container">
                ...
                <p class="text-right mt-5"><a class="txt-blue-link" href="{{route('delete.seeker')}}" onclick="return window.confirm('お祝い金申請中の場合、受け取りができなくなります。よろしいですか？');">退会する</a></p>
            </div>
