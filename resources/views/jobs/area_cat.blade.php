...
@section('title', $areaCatArchive->name . 'の求人情報 | JOB CiNEMA')
...
<div class="main-wrap">
	...
	<section class="main-section job-entry-section">
		<div class="inner">
			<div class="pad">
                <h1 class="txt-h1">{{$areaCatArchive->name}}のアルバイト求人情報</h1>
              ...
              <div class="d-flex">
                ...
                <div class="job-right">
                  <table class="job-table">
                    <tr>
                      <th><span class="money"><span class="ib-only-pc">給与</span></span></th>
                      <td>{{ str_limit($job->job_hourly_salary, $limit = 40, $end = '...')}}</td>
                    </tr>
                    <tr>
                      <th><span class="place"><span class="ib-only-pc">勤務先</span></span></th>
                      <td>{{ str_limit($job->job_office, $limit = 40, $end = '...')}}</td>
                    </tr>
										<tr>
											<th><span class="work"><span class="ib-only-pc">仕事内容</span></span></th>
											<td>{{ str_limit($job->job_desc, $limit = 80, $end = '...')}}</td>
										</tr>
                    <tr>
                      <th><span class="time"><span class="ib-only-pc">勤務時間</span></span></th>
