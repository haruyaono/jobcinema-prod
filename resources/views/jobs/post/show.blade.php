                ...
                <div class="card-body">
                    <div class="form-group e-image-register-area">
                        <div class="e-image-register-item">
                            <p class="e-image-wrap"><img src="@if($job->job_img) {{$job->job_img}}@else {{asset('uploads/images/no-image.gif')}}@endif" alt="写真"></p>
                        </div>
                        <div class="e-image-register-item">
                            <p class="e-image-wrap"><img src="@if($job->job_img2) {{$job->job_img2}}@else {{asset('uploads/images/no-image.gif')}}@endif" alt="写真"></p>
                        </div>
                        <div class="e-image-register-item">
                            <p class="e-image-wrap"><img src="@if($job->job_img3) {{$job->job_img3}}@else {{asset('uploads/images/no-image.gif')}}@endif" alt="写真"></p>
                        </div>
