        ...
        <div class="card-body mypage-card">
          <form method="POST" action="{{route('mypage.changeemail.post')}}">
            ...
            <div class="form-group text-left d-sm-flex justify-content-center">
              ...
              <div class="col-lg-3 col-md-3 col-sm-4 col-10 px-1">{{Auth::user()->email}}</div>
            </div>
            <div class="form-group text-left d-sm-flex justify-content-center">
              <label for="password" class="col-md-3 col-sm-4 col-12 px-0">
                新しいメールアドレス
              </label>
                <input id="email" type="email" class="form-control col-lg-3 col-md-3 col-sm-4 col-10" name="email" required>
            </div>
            <div class="mt-4">
