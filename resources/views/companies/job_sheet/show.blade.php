                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group e-image-register-area">
                                ...
                                <div class="e-image-register-item">
                                    <p class="e-image-wrap"><img src="@if($jobitem->job_img21){{ $jobBaseUrl . config('fpath.job_sheet_img') . $jobitem->job_img_2}}@else{{asset('img/common/no-image.gif')}}@endif" alt="写真"></p>
                                </div>
                                <div class="e-image-register-item">
