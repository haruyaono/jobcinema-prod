        ...
        <div class="inner">
            <div class="pad">
                ...
                <div class="col-md-10 mr-auto ml-auto">
                    ...
                    @endif
                    <form id="JobSheetCompanyRegisterSubimageForm" action="{{ route('enterprise.update.jobsheet.subimage1', [$jobitem]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <input type="hidden" name="data[File][currentPath]" value="{{ $images[1] }}" id="FileCurrentPath">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="pre-main-image"><img src="{{ $images[1] }}" alt="サブ写真を登録してください"></p>
                                @endif
                                <ul class="list-unstyled">
    ...
    $(function() {
        ...
        $('#deleteImage').click(function() {
            if (window.confirm('登録されているサブ写真を削除します。よろしいですか？')) {
                window.location.href = '/enterprise/jobs/create/delete_image/' + job.id + '?flag=2';
                return false;
            }
        });
    });
