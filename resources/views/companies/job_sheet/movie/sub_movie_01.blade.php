        ...
        <div class="inner">
            <div class="pad">
                ...
                <div class="col-md-10 mr-auto ml-auto">
                    ...
                    @endif
                    <form class="file-apload-form" action="{{ route('enterprise.update.jobsheet.submovie1', [$jobitem]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <input type="hidden" name="data[File][currentPath]" value="{{ $movies[1] }}" id="FileCurrentPath">
                        @else
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="pre-main-image">
                                    <video src="{{ $movies[1] }}" controls controlsList="nodownload" preload="none" playsinline width="100%">
                                    </video>
                                </p>
                                @endif
                                <ul class="list-unstyled">
    ...
    $(function() {
        ...
        $('#deleteMovie').click(function() {
            if (window.confirm('登録されているサブ動画を削除します。よろしいですか？')) {
                window.location.href = '/enterprise/jobs/create/delete_movie/' + job.id + '?flag=2';
                return false;
            }
        });
    });
