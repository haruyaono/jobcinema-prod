                                ...
                                <table cellspacing="0" cellpadding="0" class="table companyJobsheetJobitemTable">
                                    <tr>
                                        ...
                                        <td rowspan="3" class="sheetBtnBox">
                                            ...
                                            @if($jobitem->status === 0)
                                            <a class="btn companyJobsheetJoblistBtn joblistEditBtn" href="{{ route('edit.jobsheet.step2', [$jobitem]) }}" target="_blank">
                                                <i class="far fa-edit mr-1"></i>変更・掲載する
                                            </a>
                                            @elseif ($jobitem->status === 1)
                                            <a class="btn companyJobsheetJoblistBtn joblistCancelBtn" href="{{ route('edit.jobsheet.status.apply_cancel', [$jobitem]) }}" target="_blank">
                                            ...
                                            <a class="btn companyJobsheetJoblistBtn joblistCancelBtn" href="{{ route('edit.jobsheet.status.postend', [$jobitem]) }}" target="_blank">
    ...
    function del_confirm(obj, sheet_id) {
        ...
        if (modalContent) {
            ...
            modal.addFooterBtn('削除する', 'btn btn-secondary', function() {
                ...
                location.href = '/company/joblist/job/delete/' + sheet_id;
            });
