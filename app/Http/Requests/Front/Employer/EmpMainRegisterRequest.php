...
class EmpMainRegisterRequest extends FormRequest
{
    ...
    {
        return [
            'company_form.employer.last_name' => 'required|string|max:191',
            'company_form.employer.first_name' => 'required|string|max:191',
            'company_form.employer.last_name_katakana' => 'required|string|max:191|katakana',
            'company_form.employer.first_name_katakana' => 'required|string|max:191|katakana',
            'company_form.employer.phone1' => 'required|numeric|digits_between:2,5',
            'company_form.employer.phone2' => 'required|numeric|digits_between:1,4',
            'company_form.employer.phone3' => 'required|numeric|digits_between:3,4',
    ...
    {
        return [
            'company_form.employer.last_name' => 'ご担当者様の名',
            'company_form.employer.first_name' => 'ご担当者様の姓',
            'company_form.employer.last_name_katakana' => 'ご担当者様の名（カナ）',
            'company_form.employer.first_name_katakana' => 'ご担当者様の姓（カナ）',
            'company_form.employer.phone1' => 'ご担当者様電話番号1',
            'company_form.employer.phone2' => 'ご担当者様電話番号2',
            'company_form.employer.phone3' => 'ご担当者様電話番号3',
